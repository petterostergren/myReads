          ...
          <div className="book-top">
            <div
              ...
              style={{ width: 128, height: 193,
                backgroundImage: `url(${this.props.books.imageLinks ? this.props.books.imageLinks.thumbnail : 'https://books.google.com/googlebooks/images/no_cover_thumb.gif'})` }}></div>
